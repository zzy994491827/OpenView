...
data_dict = np.load('./dataset/omniobject3D/npy/point_clouds_with_image_text_sampled_for_retrieval.npy', allow_pickle=True).item()
with torch.no_grad():
    for key, value in tqdm(data_dict.items()):
        ...
        three_d_features = model(images_feat,N_sample,xyz, feat)
